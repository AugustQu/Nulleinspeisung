# TestSolar2
#
# notiere Werte Wechselrichter und Stromzaehler in entsprechende Dateien
...
#
with urllib.request.urlopen("http://192.168.0.15/api/record/live") as url_solar:
    solar = url_solar.read()
#    print(solar)
...
#print("-------------")
#get_server=requests.get("http://192.168.0.16/cm?cmnd=status%2010")
#json_data = get_server.json()
#print(json_data)
#stat_snss= json_data["StatusSNS"]["SML"]["Verbrauch_Summe"]
#print( stat_snss)
#print( int(stat_snss*10))
...
#    print( zaehler )
#    zaehler2=json.loads(zaehler.decode('utf-8'))
#    stat_snss= zaehler2["StatusSNS"]["SML"]["Einspeisung_Summe"]
#    print( stat_snss)
    datei = open("/home/august/Solar/zaehler"+jetzt+".json", "w+t")
